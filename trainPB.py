...
if __name__ == "__main__":
    ...
    dsProps = {
        ...
        "V"  : {"files": inFiles , "peaks": wepeaksVal  , "walls": wewalls, "backgrounds": webackgrounds, "n": max(2**14,math.ceil(peakbot.Config.BATCHSIZE*peakbot.Config.STEPSPEREPOCH8/len(inFiles)))                  , "shuffleSteps": 1E4},
