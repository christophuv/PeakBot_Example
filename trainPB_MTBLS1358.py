...
if __name__ == "__main__":
    ...
    inFiles = {        
        "HT_SOL1_LYS_010_pos": {"file": "./Data/MTBLS1358/HT_SOL1_LYS_010_pos.mzXML", "params": "MTBLS1358"},
        "HT_SOL2_LYS_014_pos": {"file": "./Data/MTBLS1358/HT_SOL2_LYS_014_pos.mzXML", "params": "MTBLS1358"},
    }
    exFiles = {
        #"HT_SOL1_SUP_025_pos": {"file": "./Data/MTBLS1358/HT_SOL1_SUP_025_pos.mzXML", "params": "MTBLS1358"},
        #"HT_SOL2_SUP_029_pos": {"file": "./Data/MTBLS1358/HT_SOL2_SUP_029_pos.mzXML", "params": "MTBLS1358"},
        "HT_SOL3_LYS_018_pos": {"file": "./Data/MTBLS1358/HT_SOL3_LYS_018_pos.mzXML", "params": "MTBLS1358"},
        #"HT_SOL3_SUP_033_pos": {"file": "./Data/MTBLS1358/HT_SOL3_SUP_033_pos.mzXML", "params": "MTBLS1358"},
    }
    ...
    peakBotModelFile = "./temp/PBmodel_MTBLS1358.model.h5"
    logDir = "./temp/logs"
    ...
    histAll = None
    try:
        os.remove(os.path.join(".", "Data", "History_MTBLS1358.pandas.pickle"))
    except Exception:
        pass
    ...
    for i in range(args.replicates):
        ...
        with strategy.scope():
            ...
            ## (no changes are required here)
            histAll.to_pickle(os.path.join(".", "Data", "History_MTBLS1358.pandas.pickle"))
    ...
    ## (no changes are required here)
    df = pd.read_pickle(os.path.join(".", "Data", "History_MTBLS1358.pandas.pickle"))
    ...
    df.to_csv(os.path.join(".", "Data", "SummaryPlot_MTBLS1358.tsv"), sep="\t", index=False)
    ...
    plot = (p9.ggplot(df, p9.aes("set", "value", colour="set"))
            ...
            + p9.ggtitle("MTBLS1358: Training losses/metrics") + p9.xlab("Training/Validation dataset") + p9.ylab("Value")
            + p9.theme(legend_position = "none", panel_spacing_x=0.5))
    p9.options.figure_size = (5.2,5)
    p9.ggsave(plot=plot, filename=os.path.join(".", "Data", "SummaryPlot_MTBLS1358.png"), width=5.2, height=3, dpi=300)
